...
export class AuthEffects {
  ...
  login$ = this.actions$.pipe(ofType<fromAuth.Login>(fromAuth.AuthActionTypes.Login),
  tap(() => {
  ...
  loginComplete$ = this.actions$
    .pipe(ofType<fromAuth.Login>(fromAuth.AuthActionTypes.LoginComplete),
    exhaustMap(() => {
  ...
  loginErrorRedirect$ = this.actions$
    .pipe(ofType<fromAuth.LoginFailure>(fromAuth.AuthActionTypes.LoginFailure),
  ...
  checkLogin$ = this.actions$
    .pipe(ofType<fromAuth.CheckLogin>(fromAuth.AuthActionTypes.CheckLogin),
    exhaustMap(() => {
  ...
  @Effect({ dispatch: false })
  logout$ = this.actions$
      .pipe(ofType<fromAuth.LogoutConfirmed>(fromAuth.AuthActionTypes.LogoutConfirmed),
